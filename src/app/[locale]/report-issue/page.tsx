            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-500 via-red-600 to-pink-600 dark:from-red-600 dark:via-red-700 dark:to-pink-700 p-8 md:p-12 lg:p-16">
              <div className="relative z-10 flex flex-col items-center text-center gap-6">
                ...
                <p className="text-lg md:text-xl text-white/90 max-w-2xl leading-relaxed">
                  Help us make N.18 Inanam a better place. Your report matters and can drive real change in your community.
                </p>
        ...
        <section className="w-full max-w-4xl px-4 md:px-0 py-10 md:py-20">
          <div className="bg-white dark:bg-background-dark rounded-lg border border-gray-200 dark:border-gray-800 p-8 mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              To report an issue, you need to be logged in. This helps us track reports and keep you updated on their progress.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild className="rounded-lg h-12 px-5 bg-primary text-white text-base font-bold">
                <Link href="/community/login">Login to Report</Link>
              </Button>
              <Button asChild variant="outline" className="rounded-lg h-12 px-5">
                <Link href="/community/register">Create an Account</Link>
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col gap-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-background-dark p-6 hover:shadow-lg transition-all">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Describe the Issue</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Provide details about the problem you've encountered in your community.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-background-dark p-6 hover:shadow-lg transition-all">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Add Location</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Pinpoint the exact location on a map so authorities can find and address it.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-background-dark p-6 hover:shadow-lg transition-all">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Track Progress</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Monitor your report's status and get updates as it's being resolved.
              </p>
            </div>
          </div>
        </section>
