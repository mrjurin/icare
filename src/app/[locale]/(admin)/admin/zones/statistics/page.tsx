...
export default async function ZoneStatisticsPage() {
  const t = await getTranslations("zones.statistics");
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="rounded-xl border border-gray-200 bg-white p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-sm text-gray-600">{t("totalPeople")}</p>
          </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-sm text-gray-600">{t("totalChildren")}</p>
          </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-sm text-gray-600">{t("eligibleVoters")}</p>
          </div>
      ...
      {statistics.length === 0 ? (
        <div className="rounded-xl border border-gray-200 bg-white p-12 text-center">
          ...
          <p className="text-gray-600">{t("createZonesAndAssign")}</p>
        </div>
      ) : (
            ...
            <div key={stat.zone_id} className="rounded-xl border border-gray-200 bg-white p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="rounded-lg border border-gray-200 bg-orange-50 p-4">
                  <p className="text-sm text-gray-600 mb-1">{t("totalChildren")}</p>
                ...
                <div className="rounded-lg border border-gray-200 bg-green-50 p-4">
                  <p className="text-sm text-gray-600 mb-1">{t("eligibleVoters")}</p>
              ...
              {stat.locality_breakdown.length > 0 ? (
                <div>
                  <h3 className="text-sm font-semibold text-gray-700 mb-3">{t("votingLocalityBreakdown")}</h3>
