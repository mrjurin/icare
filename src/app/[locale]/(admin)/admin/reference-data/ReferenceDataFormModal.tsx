...
export default function ReferenceDataFormModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (table === "zones" && !formData.dunId) {
      alert(t("form.selectDun") || "Please select a DUN");
      return;
    }
    if (table === "cawangan" && !formData.zoneId) {
      alert(t("form.selectZone") || "Please select a Zone");
      return;
    }
    if (table === "villages" && !formData.cawanganId) {
      alert(t("form.selectCawangan") || "Please select a Cawangan");
      return;
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {table === "zones" && (
              <>
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">
                    {t("form.pollingStation") || "Polling Station"}
                  </label>
                  <SearchableSelect
                    ...
                    placeholder={t("form.selectPollingStation") || "Select polling station..."}
                  />
                </div>
              </>
            )}
            ...
            {table === "cawangan" && (
              <div>
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">
                  {t("form.zone") || "Zone"} <span className="text-red-500">*</span>
                </label>
                <SearchableSelect
                  ...
                  placeholder={t("form.selectZone") || "Select zone..."}
                  required
                />
              </div>
            )}
            ...
            {table === "villages" && (
              <div>
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">
                  {t("form.cawangan") || "Cawangan"} <span className="text-red-500">*</span>
                </label>
                <SearchableSelect
                  ...
                  placeholder={t("form.selectCawangan") || "Select cawangan..."}
                  required
                />
              </div>
            )}
