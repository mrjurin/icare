...
import VillageFormModal from "../../villages/VillageFormModal";
    ...
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              {zone.description || "Zone details and village management"}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <div className="text-sm text-gray-600 mb-1">Zone Name</div>
            <div className="text-lg font-semibold text-gray-900">{zone.name}</div>
          </div>
          <div>
            <div className="text-sm text-gray-600 mb-1">Total Villages</div>
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Villages in {zone.name}</h2>
            <p className="text-gray-600 text-sm mt-1">
              Manage villages assigned to this zone
            </p>
          </div>
          <VillageFormModal
