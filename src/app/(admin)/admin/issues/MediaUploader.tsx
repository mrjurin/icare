      ...
      for (const file of files) {
        ...
        if (uploadError) {
          ...
          if (uploadError.message.includes("row-level security policy")) {
            errorMessage = "Permission denied. Please ensure you are logged in and have permission to upload files.";
          } else if (uploadError.message.includes("new row violates")) {
            errorMessage = "Storage permission denied. Please check your account permissions.";
          }
